...
export class ProfileView extends React.Component {
  ...
  getUser(token) {
    let url =
      "https://brunoza-api.herokuapp.com/users/" + localStorage.getItem("user");
    axios
      .get(url, {
          ...
          <Card.Body>
            ...
            <Card.Text>
              <ListGroup variant="flush">
                <ListGroupItem>
                  Username:
                  <span style={{ marginLeft: "5px" }} className="text-color">
                    {username}
                  </span>
                </ListGroupItem>
                <ListGroupItem>
            ...
            <Link to="/update/me">
              <Button style={{ margin: "3px" }} variant="info">
                Edit Profile
              </Button>
            </Link>
            <Button
